...
import pyuseragents
# < = = = = = = = = = = = = = = = = = = = = [ CODE ] = = = = = = = = = = = = = >
Fosh = ["کص ننت","کونی","ننتو گاییدم","کص مادرت","کیرم لا پا ننت زجه نزن","ریدم ت کص مادرت","کص نصلت","ننت زیرمه خارجنده","کیرمی بصیک","بدو نبینمت خارجنده😂😂","کیرم ت کص مردع و زندت\nخارتو میگام زنازاده کیرم لا ممه ننت خارجنده حرومی کیرمو میدم دس ننت ننه فیشری ننه کیر دزد ننه حروم لقمه کیرم ت اولو اخرت کیروم ت قبر مردهات کیرم ت کون بابات ننتو عمودی میگام ننتو رو هوا میگام خارکصه","مادر زنازاده😂","هعیی ننتو گاییدم زجه بزن","توپ تانک فشفشه مادر تو کونکشه","ننتو ع کون گاییدم😂😂","ننتو انال گاییدم ","خارجنده ننت پیشمه","خبری از  خواهرت داری ؟ میدونی دارم میگامش ؟","کیر برع ت مادر کیر پرستت","هعی کص  ناموصت","زجه بزن درت بیارم😂😂","خار کیر دزد","ابجی بچه سالتو گاییدم😂😂","زیرمی زجه بزن","مادرتو یام یام کردم😂😂","هعیییی خارجنده رو نگا"‌,"ای بابا چرا زجه میزنی خارکصه ؟","اروم بگیر ننه حرمله"]
